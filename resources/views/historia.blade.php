...
<html>
	<head>
		<title>La historia del Cine</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Logo -->
						<h1><a href="{{route('index')}}" id="logo">La Historia <em>del Cine</em></a></h1>
						...
						<div id="content">
							...
							<!-- Content -->
								...
								<article>
									...
									<span class="image featured"><img src="{{$historia['imagen']}}" alt="" /></span>
